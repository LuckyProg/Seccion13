...
<html>
    ...
    <body class="#bbdefb blue lighten-4">
        ...
        <div class="container" style="background:#fafafa; margin-top: 50px; margin-bottom: 50px; padding:70px; padding-top: 30px;">
            <h5 class="brand-logo" style="color:#757575;">Posts</h5>
            <br><br>
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Buscar por.." title="Type in a name">
            <table id="myTable" >
                <tr class="header">
                  <th style="width:16.6%;">Título</th>
                  <th style="width:16.6%;">Texto</th>
                  <th style="width:16.6%;">Documento</th>
                  <th style="width:16.6%;">Imagen</th>
                  <th style="width:16.6%;">Fecha</th>
                  <th style="width:16.6%;">Borrar</th>
                </tr>
                <%ArrayList<Post> posts= new Post().obtenerPost();
                    for(Post post:posts){%>
                    <tr>
                        <td><%=post.getTitulo()%></td>
                        <td><%=post.getTexto()%></td>
                        <td><%=post.getRutaDocumento()%></td>
                        <td><%=post.getRutaImagen()%></td>
                        <td><%=post.getFecha()%></td>
                        <td>
